    ...
    <div class="container">
      <div class="row g-3 justify-content-center">
        <div class="col-lg-10 text-center">
          <h2 class="mt-0 text--white">Education</h2>
          <!-- Breadcrumbs  -->
          <ul
...
<div class="section">
    <div class="container">
      <div class="row g-4" style="justify-content:center;"  >
        <div class="col-6 col-lg-11" style="font-size: 1.2rem;">
          <img
            src="{{ asset('img/education-img.jpeg') }}"
            alt="image"
            class="img-fluid"
          />
         
          <p class="mt-4">
           <strong>NEW!</strong> Jenkinson’s Aquarium is going virtual for schools, camps, and libraries! All educational programs are adapted to the appropriate grade level and support the New Jersey Core Curriculum Content Standards.
                ...
                <div class="col-lg-4" >
                  <div class="event-card" style="flex-direction:column">
                    ...
                    <div class="event-card__content">
                      ...
                      <p>Family Fun Learning Environment, Animal Encounters, Lunch with a Keeper, and much more.</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4" >
                  <div class="event-card" style="flex-direction:column">
                    <div class="" style="width:100%">
                      <img
                        src="{{ asset('img/outreach-programs.jpeg') }}"
                        alt="image"
                        class="event-card__img-is"
                      />
                    ...
                    <div class="event-card__content">
                      ...
                      <p>Jenkinson’s Aquarium offers educators an effective way to introduce the wonders of the aquatic world to their students.</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4" >
                  <div class="event-card" style="flex-direction:column">
                    <div class="" style="width:100%">
                      <img
                        src="{{ asset('img/speccialty-awareness.jpeg') }}"
                        alt="image"
                        class="event-card__img-is"
                      />
