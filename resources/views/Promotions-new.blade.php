    ...
    <div class="container">
      <div class="row g-3 justify-content-center">
        <div class="col-lg-10 text-center">
          <h2 class="mt-0 text--white">Promotions</h2>
          <!-- Breadcrumbs  -->
          <ul
  ...
  <div class="container">
    <div class="row g-4" style="justify-content:center;">
      <div class="col-lg-3" style="width:40%">
        <img
          src="{{ asset('img/promotion-head.jpeg') }}"
          alt="image"
      ...
      <div align="center"><p>Be sure to check back often, you never know when we'll add a new offer!</p></div>
                ...
                <div class="event-card" style="flex-direction:column">
                  ...
                  <div class="event-card__content">
                    <h6 class="event-card__title mb-2">
                      <a
                        href="/product/buy-5-get-1-free-{{ $name_product }}"
