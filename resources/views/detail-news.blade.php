...
<div class="banner" style="background-image: url({{ asset('images/banner-img-1.png') }})">
  <div class="banner__content">
    <div class="container">
      <div class="row g-3 justify-content-center">
        <div class="col-lg-10 text-center">
          <h2 class="mt-0 text--white">{{ $post->title }}</h2>
          <!-- Breadcrumbs  -->
          <ul
...
<div class="section">
  <div class="container">
    <div class="row g-4" style="justify-content:center;"  >
      <div class="col-md-8 col-lg-10" style="font-size: 1.2rem;">
        <img
          src="{{ asset($post->img) }}"
          alt="image"
          class="img-fluid"
        ...
        <h4>Display Comments</h4>
                    ...
                    <form method="post" action="{{ route('comments.store') }}">
                        ...
                        <div class="form-group">
                            <input type="submit" style="background-color:green;" class="btn btn-success mt-3" value="Add Comment" />
                        </div>
                    </form>
              ...
              <div class="blog-post__overlay">
                ...
                <div class="blog-post__content">
                  <h4 class="blog-post__title">
                    <a href="/exhibits" class="t-link blog-post__title-link">
                      Animals & Exhibits
                    </a>
                  </h4>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="blog-post">
              ...
              <div class="blog-post__overlay">
                ...
                <div class="blog-post__content">
                  <h4 class="blog-post__title">
                    <a href="/error" class="t-link blog-post__title-link">
                      Peguin Cam
                    </a>
                  </h4>
                ...
                <div class="client-slider">
                    <div class="client-slider__item">
                        <div class="client-card">
                            <img src="{{ asset('images/client-1.png') }}" alt="image" class="client-card__img">
                        </div>
                    </div>
                    <div class="client-slider__item">
                        <div class="client-card">
                            <img src="{{ asset('images/client-2.png') }}" alt="image" class="client-card__img">
                        </div>
                    </div>
                    <div class="client-slider__item">
                        <div class="client-card">
                            <img src="{{ asset('images/client-3.png') }}" alt="image" class="client-card__img">
                        </div>
                    </div>
                    <div class="client-slider__item">
                        <div class="client-card">
                            <img src="{{ asset('images/client-4.png') }}" alt="image" class="client-card__img">
                        </div>
                    </div>
                    <div class="client-slider__item">
                        <div class="client-card">
                            <img src="{{ asset('images/client-5.png') }}" alt="image" class="client-card__img">
                        </div>
                    </div>
                    <div class="client-slider__item">
                        <div class="client-card">
                            <img src="{{ asset('images/client-6.png') }}" alt="image" class="client-card__img">
                        </div>
                    </div>
                    <div class="client-slider__item">
                        <div class="client-card">
                            <img src="{{ asset('images/client-7.png') }}" alt="image" class="client-card__img">
                        </div>
                    </div>
                    <div class="client-slider__item">
                        <div class="client-card">
                            <img src="{{ asset('images/client-8.png') }}" alt="image" class="client-card__img">
                        </div>
                    </div>
                </div>
            </div>
