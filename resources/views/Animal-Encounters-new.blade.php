...
<body>
  ...
  <!-- Header End -->
    ...
    <!-- Banner  -->
<div class="banner" style="background-image: url({{ asset('img/banner-8.avif') }})">
  <div class="banner__content">
    <div class="container">
      <div class="row g-3 justify-content-center">
        <div class="col-lg-10 text-center">
          <h2 class="mt-0 text--white">Encounters</h2>
          <!-- Breadcrumbs  -->
          <ul
  ...
  <div class="container">
    <div class="row g-4" style="justify-content:center;">
      <div class="col-lg-3" style="width:40%">
        <img
          src="{{ asset('img/encounter-head.jpeg') }}"
          alt="image"
              ...
              <div class="col-lg-3" >
                <div class="event-card" style="flex-direction:column">
                  <div class="" style="width:100%">
                    <img
                      src="{{ asset('encounter/'.$img_to_present) }}"
                      alt="image"
                      class="event-card__img-is"
                    />
                  ...
                  <div class="event-card__content">
                    <h6 class="event-card__title mb-2">
                      ...
                      <a
                        href="/product/penguin-encounters"
                        class="t-link " style="color:#007faf"
                      >
                      @else
                      <a
                        href="/product/sloth-encounters"
                        class="t-link " style="color:#007faf"
                      >
                      @endif
                      <span>Encounter: {{ $encounter->animal_name }}</span>
                      </a>
                    </h6>
                  
                    <p>From: ${{ $encounter->price }}</p>
      ...
      <div class="container">
        <div class="row g-4">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="blog-post">
              <img
                src="{{ asset('img/promotion-1.jpeg') }}"
                alt="image"
                class="blog-post__img"
              />
              <div class="blog-post__overlay">
                ...
                <div class="blog-post__content">
                  <h4 class="blog-post__title">
                    <a href="/services/promotions" class="t-link blog-post__title-link">
                      Promotions
                    </a>
                  </h4>
