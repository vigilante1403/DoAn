...
<body>
  ...
  <!-- Header End -->
    ...
    <!-- Banner  -->
<div class="banner" style="background-image: url({{ asset('img/banner-5.avif') }})">
  <div class="banner__content">
    <div class="container">
      <div class="row g-3 justify-content-center">
        <div class="col-lg-10 text-center">
          <h2 class="mt-0 text--white">Adoption</h2>
          <!-- Breadcrumbs  -->
          <ul
...
<div class="section">
  <div class="container">
    <div class="row g-4" style="justify-content:center;">
      ...
      <div class="col-12 col-lg-12" style="font-size: 1.2rem;"align="center">
        
         <p>Did you know you can Adopt An Animal from Jenkinson's Aquarium? Choose from Penguins, Sloth, Seals, Sharks or Sea Turtle - each kit comes with a plush animal, adoption certificate, photo and 2 aquarium passes.! We can not guarantee delivery before Christmas.</p>
                ...
                <div class="event-card" style="flex-direction:column">
                  ...
                  <div class="event-card__content">
                    <h6 class="event-card__title mb-2">
                      <a
                        href="/product/{{ $name_product }}/{{ $animal->id }}"
      ...
      <div class="container">
        <div class="row g-4">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="blog-post">
              <img
                src="{{ asset('img/encounter-1.jpeg') }}"
                alt="image"
                class="blog-post__img"
              />
              <div class="blog-post__overlay">
                ...
                <div class="blog-post__content">
                  <h4 class="blog-post__title">
                    <a href="/services/animal-encounters" class="t-link blog-post__title-link">
                      Animal-Encounters
                    </a>
                  </h4>
