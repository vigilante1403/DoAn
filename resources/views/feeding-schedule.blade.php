    ...
    <div class="container">
      <div class="row g-3 justify-content-center">
        <div class="col-lg-10 text-center">
          <h2 class="mt-0 text--white">Feedings Time</h2>
          <!-- Breadcrumbs  -->
          <ul
...
<div class="section">
  <div class="container">
    <div class="row g-4" style="justify-content:center;"align="center">
      
      <div class="col-12 col-lg-12" style="font-size: 1.2rem;">        
          <div class="row g-4" style="flex-direction:row;justify-content: space-evenly  ;">
              <div class="col-lg-4" >
                <div class="event-card" style="flex-direction:column; " >
                  <h4 class="event-card__title mb-2">
                    
                    <span>Summer Feedings</span>
                   
                  </h4>
                  <p><strong><em> begins 6/23/2022</em></strong></p>
                  <div class="" style="width:100%">
                    <img
                      src="{{ asset('img/feeding-1.jpeg') }}"
                      alt="image"
                      class="" style="border-radius: 50%;" height="80%" width="80%"
                    />

                  </div>
                  <div class="event-card__content" align="left">
                   
                    <p><strong>Seals:</strong> 10am, 3pm, &amp; 8pm Daily</p>
                    <p><strong>Penguins:</strong> 12pm &amp; 7:30pm Daily</p> 
                    <p><strong>Sharks:</strong> 4pm Mondays, Wednesdays &amp; Saturdays</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-4" >
                <div class="event-card" style="flex-direction:column;">
                  <h4 class="event-card__title mb-2">
                    ...
                    <span>Off Season Feedings</span>
                    
                  </h4>
                  <P><strong><em>begins 9/6/2022</em></strong> </P>
                  <div class="" style="width:100%">
                    <img
                  ...
                  <div class="event-card__content"align="left">
                    ...
                    <p><Strong>Seals:</Strong> 10am, 1pm, & 4pm Daily</p>
                    <p><strong>Penguins:</strong> 11am &amp; 3:30pm Daily</p>
                    <p><strong>Sharks:</strong> 1:30pm Mondays, Wednesdays &amp; Saturdays</p>
