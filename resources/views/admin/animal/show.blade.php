    ...
    <div class="row mt-4">
     ...
     <div class="col-sm-3.5" style="margin-left:30px; " >
         <figure class="card  card-lg border-0" style="border:none!important;" >
             <a href="#" class="img-wrap card-img-top" data-abc="true"><img width="262px"  src="{{ asset($animal->img_path) }}"></a>
             <figcaption class="info-wrap border-0">
                        <div class="row">
 
                            <div class="container mt-4 border-0"style="text-align:center ">
 
                                <strong><a href="#" class="title" data-abc="true" style="font-size:20px;color:#2596be">{{ $animal->name }}</a></strong>
                                ...
                                <div class="bottom-wrap container mt-4" style="background-color:">
                                    <a href="addInfo/{{ $animal->id }}" style="text-decoration: none;">
