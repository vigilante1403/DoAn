    ...
    <div class="container">
      <div class="row g-3 justify-content-center">
        <div class="col-lg-10 text-center">
          <h2 class="mt-0 text--white">Animal Art</h2>
          <!-- Breadcrumbs  -->
          <ul
      ...
      <div class="col-md-8 col-lg-10" style="font-size: 1.2rem;">
        ...
        <p class="mt-4">
          <span class="description">
            The keepers at Jenkinson's Aquarium are always looking for fun and enriching activities for the animals. Painting is a part of the enrichment programs for some of our animals that is both fun for the animals and the keepers! Animals enjoy painting with non-toxic paint on a canvas to create their very own works of art!			</span>
        </p>
